...
Talho.Rollcall.Graphing.view.filter.Common = Ext.extend(Talho.Rollcall.ux.Filter, {
  ...
  initComponent: function () {
    ...
    var data_function = new Talho.Rollcall.ux.ComboBox({editable: false, emptyText: 'Data Function...', fieldLabel: 'Data Function', id: 'data_func'});
         
    var absent = new Talho.Rollcall.ux.ComboBox({editable: false, emptyText: 'Absenteeism...', fieldLabel: 'Absenteeism', id: 'absent'});
