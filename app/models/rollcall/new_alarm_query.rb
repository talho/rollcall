...
class Rollcall::NewAlarmQuery < ActiveRecord::Base
  ...
  def generate_alarms
    ...
    select = Rollcall::SchoolDailyInfo.where("report_date between ? and ?", params[:start_date], params[:end_date])
               ...
               .select("report_date, Date, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP")              
  ...
  def get_query_params
    ...
    query[:schools] = get_schools(query).pluck(:id)
