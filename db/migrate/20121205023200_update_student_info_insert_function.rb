class UpdateStudentInfoInsertFunction < ActiveRecord::Migration
  ...
  def down
    execute "DROP FUNCTION rollcall_insert_student_info(varchar, varchar, int, date, date, float, int, int, varchar, varchar, varchar, text, text, date, boolean, boolean, boolean)"
