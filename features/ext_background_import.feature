...
Scenario: Uploading a file
  ...
  When I drop the following "Attendance" file in the rollcall directory for "Houston":
  """
  ...
  """
  And I drop the following "Enrollment" file in the rollcall directory for "Houston":
  """
  101912105,Anderson Elementary,100
  101912273,Ashford Elementary,100
  101912020,Yates High School,200
  """
  And I drop the following "ILI" file in the rollcall directory for "Houston":
  """
  ...
  """
  And the rollcall background worker processes for "Houston"
