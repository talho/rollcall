...
//TODO fix type
Talho.Rollcall.ADST.view.ActionPanel = Ext.extend(Ext.Panel, {
  layout: 'auto',
  hidden: false,
  ...
  constructor: function (config) {
    ...
    Talho.Rollcall.ADST.view.ActionPanel.superclass.constructor.apply(this, config);
  },
  ...
  initComponent: function (config) {        
    ...
    Talho.Rollcall.ADST.view.ActionPanel.superclass.initComponent.apply(this, config);
  }
});