...
Scenario: User generates reports of selected school
  Given I navigate to the ext dashboard page
  And I navigate to "Apps > Rollcall > Schools"
  And I wait for the panel to load
  And I explicitly click x-grid3-cell-inner "Anderson Elementary"

  When I press "Generate ILI Report"
  And delayed jobs are processed
  Then I should see "Generating Report" within ".x-window"
  And I press "OK" within ".x-window"

  When I press "Generate Attendance Report"
  And delayed jobs are processed
  Then I should see "Generating Report" within ".x-window"
  And I press "OK" within ".x-window"
