...
Background:
  ...
  And "District2" has the following current student absenteeism data:
    ...
    | 2   | Austin Elementary School          | 18       |            |           | 07/23/1993 | 12    | M
    
Scenario: School District ILI
  When I do get_data with:
    |  |

Scenario: School ILI
  

Scenario: School District Data Functions

Scenario: School Data Functions

Scenario: School District Confirmed Illness
