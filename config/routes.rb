ActionController::Routing::Routes.draw do |map|
  map.resources :adst, :controller => "rollcall/adst", :as => 'rollcall/adst', :only => [:index]
  map.resources :alarm_query, :controller => "rollcall/alarm_query", :as => "rollcall/alarm_query", :except => [:show,:new,:edit]
  map.resources :alarms, :controller => "rollcall/alarm", :as => "rollcall/alarms", :except => [:new,:show,:edit]
  map.resources :schools, :controller => "rollcall/school", :as => "rollcall/schools", :only => [:index,:show]
  map.resources :nurse_assistant, :controller => "rollcall/nurse_assistant", :as => "rollcall/nurse_assistant", :only => [:index,:destroy]
