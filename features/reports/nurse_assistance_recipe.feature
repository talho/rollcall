Feature: Use Nurse Assistant Panel
  ...
  Scenario:
    ...
    And I generate "RecipeExternal::NurseAssistanceRecipe" rollcall report on "Rollcall::School" named "Anderson Elementary"
    ...
    And I should see "TotalReportedStudents" in the rendering
    And I should see "TotalReportedSymptoms" in the rendering
    ...
    And I should see "total_students" in the csv
    And I should see "total_symptoms" in the csv
